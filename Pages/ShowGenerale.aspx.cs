...
namespace CertQA
{
  public partial class ShowGenerale : System.Web.UI.Page
  {
    static int recordID;
    static int certNr;
    ...
    static string tag;
    static string molla;
    static string tarMolla;
    static string tarNom;
    static string tarBanco;
    static string pressImpost;
    static string pressGenerale;
    static string pressTotale;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      if (!IsPostBack){
        ...
        // first read the additional order data
        List<object> orderDetail = SAPHelper.GetSingleOrderDetail(order, orderLin);
        foreach (VBAP item in orderDetail)
        {
          lblTagValue.Text = item.ZZTAG;
          lblTarMollaValue.Text = item.ZZPREMOL;
          lblMollaValue.Text = item.ZZSPRING;
          lblTarNominaleValue.Text = item.ZZTARNOR;
          lblTarBancoValue.Text = item.ZZTARBAN;
          lblCtrPressImpostValue.Text = item.ZZPRESET;
          lblCtrPressGenValue.Text = item.ZZPREGEN;
          lblCtrPressTotaleValue.Text = item.ZZPRETOT;
        }
        // now check saved certification data
